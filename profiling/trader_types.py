...
TRADER_PROFILES = {
    ...
    "全职短线客": {
        "code": "fulltime_short", "holding_period": "1-3天", "risk_tolerance": "进取(<15%)", "screen_time": "全职(8h)", "analysis_style": "技术面+盘口", "trader_level": "高级",
        "primary_kline": "60min", "secondary_kline": "15min", "min_kline_days": 60,
        "strategy_weights": {"momentum_breakout": 2.5, "sector_rotation": 1.0, "wave_point": 0.5, "mean_reversion": 0.0},
        "risk": {"stop_loss_pct": 0.03, "take_profit_pct": 0.06, "max_position_pct": 0.25, "max_positions": 8, "daily_loss_limit_pct": -5.0, "kelly_fraction": 0.8, "trailing_stop_activation": 0.03, "trailing_stop_distance": 0.02},
        "market": {"min_score_to_trade": 30, "min_score_to_full": 55, "bear_regime_stop": False},
        "coach_style": "果断激进", "push_frequency": "实时推送", "training_focus": ["情绪管理", "冲动抑制"],
        "description": "全职盯盘的短线交易者，60分钟捕捉突破信号，高频快进快出",
    },
    "趋势跟踪者": {
    ...
    "消息面短线": {
        "code": "news_trader", "holding_period": "1-3天", "risk_tolerance": "激进(<20%)", "screen_time": "全职(8h)", "analysis_style": "消息驱动+技术确认", "trader_level": "中级",
        "primary_kline": "30min", "secondary_kline": "60min", "min_kline_days": 60,
        "strategy_weights": {"momentum_breakout": 2.0, "sector_rotation": 1.5, "wave_point": 0.0, "mean_reversion": 0.0},
        "risk": {"stop_loss_pct": 0.05, "take_profit_pct": 0.10, "max_position_pct": 0.30, "max_positions": 6, "daily_loss_limit_pct": -5.0, "kelly_fraction": 0.7, "trailing_stop_activation": 0.05, "trailing_stop_distance": 0.03},
        "market": {"min_score_to_trade": 35, "min_score_to_full": 60, "bear_regime_stop": False},
        "coach_style": "冷静克制", "push_frequency": "盘中加风控", "training_focus": ["冲动抑制", "信息甄别"],
        "description": "追逐热点消息的短线交易者，板块轮动力度最大，需强风控约束",
    },
    "价值投资者": {
...
SCREENING_CONFIGS = {
    ...
    "全职短线客": {
        ...
        "max_pe": 1000,
        "min_vol_ratio": 1.0,
        "signal_prefer": {"momentum_breakout": 2.5, "first_board": 2.0, "naked_pinbar": 1.5, "naked_engulf": 1.0, "williams_r": 1.5, "orb": 1.0, "sector_rotation": 1.0},
    },
    "趋势跟踪者": {
        "pool": "大盘趋势+周线多头",
    ...
    "消息面短线": {
        ...
        "max_pe": 2000,
        "min_vol_ratio": 0.8,
        "signal_prefer": {"sector_rotation": 2.0, "first_board": 1.5, "momentum_breakout": 2.0, "naked_pinbar": 1.0, "pullback": 1.0},
    },
    "价值投资者": {
        "pool": "沪深300+低PE+高ROE",
...
def detect_profile_from_answers(answers):
    ...
    holding_map = {"A": "全职短线客", "B": "消息面短线", "C": "上班族中短线", "D": "趋势跟踪者", "E": "价值投资者"}
    if answers.get("q1") in holding_map:
        scores[holding_map[answers["q1"]]] += 25
    risk_map = {"A": "新手入门", "B": "上班族中短线", "C": "全职短线客", "D": "消息面短线"}
    if answers.get("q2") in risk_map:
        scores[risk_map[answers["q2"]]] += 25
    time_map = {"A": "全职短线客", "B": "趋势跟踪者", "C": "上班族中短线", "D": "价值投资者"}
