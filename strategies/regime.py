...
REGIME_CONFIG = {
    ...
    "bull_strong": {"strategies": ["wave_point", "mean_reversion"], "params": {}, "max_positions": 5, "kelly_mult": 1.0},
    "bull_weak":   {"strategies": ["wave_point", "mean_reversion"], "params": {}, "max_positions": 3, "kelly_mult": 0.7},
    "range":       {"strategies": ["mean_reversion"], "params": {}, "max_positions": 2, "kelly_mult": 0.5},
